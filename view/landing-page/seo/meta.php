...
if (isset($_POST['update'])) {
    ...
    // Xác thực nhập tệp để kiểm tra xem có mở rộng hợp lệ không
        ...
        if (move_uploaded_file($_FILES['logo']['tmp_name'],getcwd().'/'.$path_img_lp_logo.$_FILES['logo']['name']))
        {
            $id_lp_setting = $_POST['id_lp_setting'];
            ...
            echo '<script>alert("'.getcwd().'/'.$path_img_lp_logo.$_FILES['logo']['name'].'");</script>';
            // echo "<script>window.location.assign('admin.php?go=setting_landingpage');</script>";
            }
        else {
            $response = array(
                "type" => "danger",
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Cài đặt website landing page</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/admin.php">Trang chủ Admin</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cài đặt website landing page</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div style="width:50%"><img src="../controller/uploaded/landing-page/logo/<?php echo $logo;?>" class="img-thumbnail mt-3"/></div>
                            </div>
                            </div>
